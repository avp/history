...
The election of 1844 resulted in Democrat \textbf{James K.\ Polk}, ``Young Hickory'',
...
where he met a Texan garrison at the \textbf{Alamo}.
...
American amphibious landing at \textbf{Veracruz}.
...
This initiated the \textbf{Bear Flag Revolt},
...
\begin{itemize}
  ...
  \item
    \textbf{Wild Bill Hickok} was a legendary figure of the Wild West,
...
However, the gold discovery and resulting \textbf{California Gold Rush}
...
Word spread when people like Samuel Brannan, publisher of the \textit{Star},
...
Lewis Cass and Martin Van Buren were defeated by Whig \textbf{Zachary Taylor},
``Old Rough-and-Ready''.
...
Also in 1854, the \textbf{Kansas-Nebraska Act} was passed,
...
\textbf{John J. Crittenden} had been the Attorney General
...
who was involved in the \textit{Ex parte Milligan} case.
...
At Hampton Roads,
the two ironclads USS \textbf{Monitor} and CSS \textit{Virginia} (formerly the \textbf{Merrimack})
...
On April 14,
Lincoln and first lady Mary Todd went to a performance of \textit{Our American Cousin},
...
Johnson's Secretary of State, \textbf{William Seward},
...
and sympathized with the North were referred to as \textbf{scalawags}.
...
\textbf{Jay Gould} and \textbf{James Fisk}
...
The first \textbf{Homestead Act} had been passed in 1862,
