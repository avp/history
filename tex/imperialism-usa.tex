...
Mark Twain coined the term \textbf{Gilded Age}
...
Republican \textbf{Rutherford B. Hayes} was up against Democrat \textbf{Samuel Tilden},
...
because she was a big supporter of the \textbf{temperance movement} to ban alcohol.
...
\textbf{Alexander Graham Bell} brought a metal detector to find bullets,
...
To this end,
his administration managed to pass the McKinley Tariff and the \textbf{Sherman Silver Purchase Act}
...
\subsection*{The Frontier: Wars with the Apache}
...
Cochise then worked on peace talks with \textbf{Otis Howard},
...
Crook was promptly replaced by \textbf{Nelson Miles},
...
He defeated \textbf{William Jennings Bryan}
...
Eventually, the \textbf{USS Maine},
...
The letter, sent to the Foreign Minister of Spain, Don Jos\'e Canelejas,
...
also called the \textbf{Rough Riders},
...
and at the \textbf{Battle of San Juan Hill}, near Kettle Hill.
...
\subsection*{Organizing Labor}

Poor labor conditions in the early nineteenth century
resulted in the creation of the \textbf{Knights of Labor} in 1869.
Led by Grand Master Workmen such as Uriah Stephens and \textbf{Terence Powderley},
the Knights were the first large labor organization in the United States.
Members of the union killed many Chinese laborers in the 1885 \textbf{Rock Springs Massacre},
and they attempted a strike against Jay Gould's Great Southwest Railroad in 1886.

On May 1, 1886,
anarchists threw a bomb at police officers in \textbf{Haymarket Square} in Chicago
...
Governor \textbf{John Peter Altgeld} ended up pardoning everyone else,
but the Knights of Labor were blamed for the incident and their reputation was irredeemably damaged.

This paved the way for the rise of the \textbf{American Federation of Labor},
led by \textbf{Samuel Gompers}.
...
\subsection*{Women's Suffrage}

In order to discuss the history of women in the United States,
we must begin some time ago.
In the early and middle parts of the nineteenth century, the \textbf{cult of domesticity} emerged.
...
The \textbf{first wave of feminism} started at the \textbf{Seneca Falls Convention} in New York in 1848.
Organized by \textbf{Elizabeth Cady Stanton} and \textbf{Lucretia Mott},
the convention put forth a \textbf{Declaration of Sentiments}, which stated that
...
Three years later, Stanton met \textbf{Susan B.\ Anthony},
and together, they founded the New York Women's State Temperance Society, as well as the Women's Loyal National League.
In 1868, Anthony began a women's rights newspaper called \textit{The Revolution},
...
he wrote \textit{The Naval War of 1812} and \textit{The Winning of the West}.
...
Bunau-Varilla signed the \textbf{Hay-Bunau-Varilla Treaty} with the US,
...
The fourth candidate was Socialist \textbf{Eugene V. Debs},
